...
{
  # Test: Incremental 3 - All Sections (without powertop)
  # NVIDIA GPU + Kitchensink TLP + Miscellaneous power management features (i915, laptop-mode, wifi, 60Hz)

  # ========== SECTION 1: NVIDIA + Base Power Management ==========
  ...
  # ========== SECTION 2: Kitchensink TLP (all aggressive settings) ==========
  services.tlp = {
    enable = true;
    settings = {
      CPU_BOOST_ON_AC = 1;
  ...
  # ========== SECTION 3: Miscellaneous Power Management (without powertop) ==========
