...
{
  # Test: Incremental 4 - All Sections (with powertop)
  # NVIDIA GPU + Kitchensink TLP + Miscellaneous power management + Powertop
  ...
  # ========== SECTION 3: Miscellaneous Power Management (with powertop) ==========
