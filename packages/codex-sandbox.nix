...
# --share-net          re-enables network so Codex can reach the OpenAI API
...
# --bind ~/.codex      punch through codex config and instructions for persistence
...
pkgs.writeShellScriptBin "codex-sandbox" ''
  mkdir -p "$HOME/.codex"
