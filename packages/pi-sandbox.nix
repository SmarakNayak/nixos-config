...
# --share-net          re-enables network so pi can reach AI APIs
...
# --symlink /bin/sh    pi and its tools can spawn shell commands;
...
# --bind ~/.pi         punch through pi config/state for persistence
